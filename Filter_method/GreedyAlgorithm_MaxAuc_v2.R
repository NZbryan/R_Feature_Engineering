...
parser$add_argument('-train_threshold',dest='train_thre',action='store',type = 'integer',
                    default = 0.95,help='The AUC threshold of train data')

parser$add_argument('-test_threshold',dest='test_thre',action='store',type = 'integer',
